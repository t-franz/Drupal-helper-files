...
if (file_put_contents("master.zip", file_get_contents($file)) ) {
    ...
    print '<p><a href="http://sandbox.fusbfg.de/admin/config/system/cron" target="_blank">Run Cron</a></p>';
    ...
    print '<br/><a href="http://sandbox.fusbfg.de/admin/config/content/ckeditor/editg#edit-skin" target="_blank">http://sandbox.fusbfg.de/admin/config/content/ckeditor/editg</a> (siehe <a href="http://ckeditor.com/download" target="_blank">CKEditor-Version</a>), <a href="https://github.com/jackmoore/colorbox#changelog" target="_blank">Colorbox</a> und <href="http://sandbox.fusbfg.de/admin/reports/libraries" target="_blank">Libraries &uuml;berpr&uuml;fen</a>';
    print '<p><a href="http://sandbox.fusbfg.de/admin/config/system/backup_migrate" target="_blank">Flush Cache and DEV-Backup</a></p>';
